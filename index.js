...
var independentFixtures = [];
var delayedDependencyFixtures = [];
var requiredDependencyFixtures = [];
var associativeProcessing = [];
...
SailsFixtures = {
    ...
    createFixtures: function() {
        ...
        var promiseIndependent = this.saveFixturesFromArray(independentFixtures);
        var promiseDelayedDependency = this.saveFixturesFromArray(delayedDependencyFixtures);

        var promise = Q.all([promiseIndependent, promiseDelayedDependency])
...
Fixture.prototype.updateAssociations = function() {
    ...
    var that = this;
    var Model = sails.models[this.modelName];
